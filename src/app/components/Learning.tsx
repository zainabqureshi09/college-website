...
export const LearningMaterials = () => {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-6 py-12">
      ...
      <Link href="https://zainab-chat-agent.vercel.app/"  className="mt-4 p-6 bg-blue-600 text-white rounded w-full h-[400px] border-none" target="_blank">💬 Chat with Prof. Zainab</Link>
